...
class KittiDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Note:
            You need to have downloaded the Kitti dataset first and
            provide the path to where it is saved.
        ...
        In total there are 34 classes but some of these are not useful
        so by default we use only 19 of the classes
        ...
        Args:
            data_dir: where to load the data from path, i.e.
